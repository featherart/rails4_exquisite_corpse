...
It should render a view that allows artists to add to an existing drawing:
  ...
  Body parts can be reused infinitely many times!
...
It should render a view of "corpses" or complete bodies:
  ...
  Every body part that has been reused will show up in each drawing it belongs to

  Option to name corpse? Email completed corpse .png to self or share on FB/twitter? 
